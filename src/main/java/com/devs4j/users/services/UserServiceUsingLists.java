...
public class UserServiceUsingLists {
	...
	public List<User> getUsersStartWith(String startWith) {		//QUEDÓ PENDIENTE EN EL CONTROLLER PORQUE NOS ARROJA AMBIGUOUS POR EL @GetMapping SOLO QUE YA TIENE getUsers. PREGUNTAR A NICOLÁS COMO PODRÍA IMPLEMENTAR ESTE Método
		if(startWith != null) {
